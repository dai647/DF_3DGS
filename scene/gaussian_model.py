...
class GaussianModel:
    ...
    def capture4edit(self):
        return self._xyz,self._scaling
    ...
    def set_move_3dgs(self,mask):
        self._opacity=self._opacity[mask!=1]
        self._xyz=self._xyz[mask!=1]
        self._scaling=self._scaling[mask!=1]
        self._rotation=self._rotation[mask!=1]
        self._semantic_feature=self._semantic_feature[mask!=1]


    def get_semantic_feat(self):
    ...
    def create_from_pcd(self, pcd : BasicPointCloud, spatial_lr_scale : float, semantic_feature_size : int, speedup: bool):
        ...
        if speedup: 
            semantic_feature_size = 9
        print('--------------init 3dgs semantic feature_size: ',semantic_feature_size)
    ...
    def save_ply(self, path):
        ...
        attributes = np.concatenate((xyz, normals, opacities, scale, rotation, semantic_feature), axis=1) 
    ...
    def densification_postfix(self, new_xyz, new_opacities, new_scaling, new_rotation, new_semantic_feature):
        d = {"xyz": new_xyz,
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, N=2):
        ...
        self.densification_postfix(new_xyz, new_opacity, new_scaling, new_rotation, new_semantic_feature) 
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent):
        ...
        self.densification_postfix(new_xyz,  new_opacities, new_scaling, new_rotation, new_semantic_feature)
